...
contains
    ...
    subroutine forint(imon, for12, for1)
        ...
        real(kind=8), intent(in) :: for12(ix*il,*) !! The input field
        real(kind=8), intent(inout) :: for1(ix*il) !! The output field
    ...
    subroutine forin5(imon, for12, for1)
        integer, intent(in) :: imon         !! The month
        real(kind=8), intent(in) :: for12(ix*il,12) !! The input field
        real(kind=8), intent(inout) :: for1(ix*il)  !! The output field

        integer :: im1, im2, ip1, ip2
        real(kind=8) :: c0, t0, t1, t2, wm1, wm2, w0, wp1, wp2
